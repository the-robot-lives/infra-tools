# AGENTS.md — infra-utils

Infra ops helper scripts; see bin/ and README.md for the command inventory. Coupled to trl-infra .infra-config.yaml + terraform/; shares k8-lib.
